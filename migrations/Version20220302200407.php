 ...
 */
final class Version20220302200407 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cinta_socio (cinta_id INT NOT NULL, socio_id INT NOT NULL, INDEX IDX_1D75F25415ED566 (cinta_id), INDEX IDX_1D75F254DA04E6A9 (socio_id), PRIMARY KEY(cinta_id, socio_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE empleado (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, apellidos VARCHAR(255) NOT NULL, dni VARCHAR(255) NOT NULL, telefono INT NOT NULL, email VARCHAR(255) NOT NULL, es_supervisor TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE cinta_socio ADD CONSTRAINT FK_1D75F25415ED566 FOREIGN KEY (cinta_id) REFERENCES cinta (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE cinta_socio ADD CONSTRAINT FK_1D75F254DA04E6A9 FOREIGN KEY (socio_id) REFERENCES socio (id) ON DELETE CASCADE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cinta_socio DROP FOREIGN KEY FK_1D75F25415ED566');
        ...
        $this->addSql('ALTER TABLE cinta_socio DROP FOREIGN KEY FK_1D75F254DA04E6A9');
        $this->addSql('DROP TABLE acceso');
        $this->addSql('DROP TABLE cinta');
        $this->addSql('DROP TABLE cinta_socio');
